...
describe('Location e2e test', () => {
  ...
  describe('new Location page', () => {
    ...
    it('should create an instance of Location', () => {
      cy.get(`[data-cy="streetAddress"]`).type('parched');
      cy.get(`[data-cy="streetAddress"]`).should('have.value', 'parched');

      cy.get(`[data-cy="postalCode"]`).type('gee');
      cy.get(`[data-cy="postalCode"]`).should('have.value', 'gee');

      cy.get(`[data-cy="city"]`).type('Haleytown');
      cy.get(`[data-cy="city"]`).should('have.value', 'Haleytown');

      cy.get(`[data-cy="stateProvince"]`).type('even between negative');
      cy.get(`[data-cy="stateProvince"]`).should('have.value', 'even between negative');
