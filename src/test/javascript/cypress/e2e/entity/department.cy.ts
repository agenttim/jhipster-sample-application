...
describe('Department e2e test', () => {
  ...
  const departmentSample = { departmentName: 'lest what' };
  ...
  describe('new Department page', () => {
    ...
    it('should create an instance of Department', () => {
      cy.get(`[data-cy="departmentName"]`).type('failing gravel potable');
      cy.get(`[data-cy="departmentName"]`).should('have.value', 'failing gravel potable');
