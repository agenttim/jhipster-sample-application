...
describe('Task e2e test', () => {
  ...
  describe('new Task page', () => {
    ...
    it('should create an instance of Task', () => {
      cy.get(`[data-cy="title"]`).type('pish calculator pish');
      cy.get(`[data-cy="title"]`).should('have.value', 'pish calculator pish');

      cy.get(`[data-cy="description"]`).type('deficient quintuple whoever');
      cy.get(`[data-cy="description"]`).should('have.value', 'deficient quintuple whoever');
