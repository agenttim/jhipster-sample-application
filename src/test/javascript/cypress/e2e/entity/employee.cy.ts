...
describe('Employee e2e test', () => {
  ...
  describe('new Employee page', () => {
    ...
    it('should create an instance of Employee', () => {
      cy.get(`[data-cy="firstName"]`).type('Ezequiel');
      cy.get(`[data-cy="firstName"]`).should('have.value', 'Ezequiel');

      cy.get(`[data-cy="lastName"]`).type('Heaney');
      cy.get(`[data-cy="lastName"]`).should('have.value', 'Heaney');

      cy.get(`[data-cy="email"]`).type('Edd_Beatty@gmail.com');
      cy.get(`[data-cy="email"]`).should('have.value', 'Edd_Beatty@gmail.com');

      cy.get(`[data-cy="phoneNumber"]`).type('until yippee');
      cy.get(`[data-cy="phoneNumber"]`).should('have.value', 'until yippee');

      cy.get(`[data-cy="hireDate"]`).type('2024-03-12T09:33');
      cy.get(`[data-cy="hireDate"]`).blur();
      cy.get(`[data-cy="hireDate"]`).should('have.value', '2024-03-12T09:33');

      cy.get(`[data-cy="salary"]`).type('4769');
      cy.get(`[data-cy="salary"]`).should('have.value', '4769');

      cy.get(`[data-cy="commissionPct"]`).type('21838');
      cy.get(`[data-cy="commissionPct"]`).should('have.value', '21838');
