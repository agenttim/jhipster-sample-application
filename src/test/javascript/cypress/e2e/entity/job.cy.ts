...
describe('Job e2e test', () => {
  ...
  describe('new Job page', () => {
    ...
    it('should create an instance of Job', () => {
      cy.get(`[data-cy="jobTitle"]`).type('Chief Brand Coordinator');
      cy.get(`[data-cy="jobTitle"]`).should('have.value', 'Chief Brand Coordinator');

      cy.get(`[data-cy="minSalary"]`).type('22443');
      cy.get(`[data-cy="minSalary"]`).should('have.value', '22443');

      cy.get(`[data-cy="maxSalary"]`).type('21705');
      cy.get(`[data-cy="maxSalary"]`).should('have.value', '21705');
